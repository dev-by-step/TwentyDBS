...
export class InternalEntityAccessDestroyManyPreQueryHook
  implements WorkspacePreQueryHookInstance
{
  ...
  async execute(
    ...
    objectName: string,
    payload: DestroyManyResolverArgs<Record<string, unknown>>,
  ): Promise<DestroyManyResolverArgs<Record<string, unknown>>> {
