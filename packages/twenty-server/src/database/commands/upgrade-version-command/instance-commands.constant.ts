...
import { GrantMemberEntityManagerUpdatePermissionFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-1/2-1-instance-command-fast-1785000000001-grant-member-entity-manager-update-permission';
...
export const INSTANCE_COMMANDS = [
  ...
  GrantMemberEntityManagerUpdatePermissionFastInstanceCommand,
];
