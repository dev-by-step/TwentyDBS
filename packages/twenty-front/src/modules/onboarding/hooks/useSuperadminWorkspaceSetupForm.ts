...
// IMP-15 : orchestration (état + effets + handlers + handleSubmit/FIX-29)
// extraite de SuperadminWorkspaceSetup pour ramener le composant sous la
// limite de 300 lignes. Déplacement verbatim, sans changement de comportement.
export const useSuperadminWorkspaceSetupForm = () => {
  const { t } = useLingui();
